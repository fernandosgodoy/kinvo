...
namespace Kinvo.Infra.Data.Mappings
{
        ...
        : MapBase<Produto>
    {
        ...
        public override void Configure(EntityTypeBuilder<Produto> builder)
        {
            ...
            builder.Property(c => c.TaxaCorretagem).HasColumnName("TaxaCorretagem").HasDefaultValue(0);
            builder.Property(c => c.TaxaAnual).HasColumnName("TaxaAnual").HasDefaultValue(0);
